const commandsData = {
  category1: {
    ...
    commands: [
      ...
      {
        name: "/submitforad",
        description: "Any donaters can submit their server for advertisement",
        permission: "All",
      },
    ],
  },
  category2: {
    ...
    commands: [
      {
        name: "/setadchannel",
        description: "Set the channel for advertisements",
        permission: "Admin",
      },
      {
        name: "/setjoinchannel",
        description: " Set the channel for join messages",
        permission: "Admin",
      },
    ],
  },
    ...
    commands: [
      {
        ...
        permission: "Maybecool Only",
      },
      {
        name: "/balance",
        description: " Check the servers balance of add credits and stats", 
        permission: "All",
      },
    ],
  },
  category4: {
    ...
    commands: [
      ...
      {
        name: "/generatekey",
        description: "Generate a key for redeeming",
        permission: "Only Maybecool",
      }
    ,{   name: "/createadvertiser",
        description: "Generate a advertiser key for the server",
        permission: "Only Maybecool",}
    ],
  },
};
